...
def soccer_sim() -> None:
    ...
    parser.add_argument('-b', '--rules',      help='The soccer rule book.',               default=SoccerRuleBooks.HL_ADULT_2025.value, type=str, choices=rule_books)
    # fmt: on
    ...
    sim = SoccerSimulation(soccer_field, rule_book, referee, args.rerun)
